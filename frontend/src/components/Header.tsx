      ...
      <div className="w-full h-full flex items-center justify-between  ">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 bg-bg-02 text-slate-700 transition-all ease-in-out duration-150 active:scale-95 hover:text-slate-200 px-4 h-10 rounded-full hover:bg-slate-900 cursor-pointer">
            ...
            <p className="text-base font-mono font-medium">0</p>
          </button>
        </div>
      </div>
    </header>
