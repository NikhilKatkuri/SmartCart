...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="bg-linear-to-br from-blue-600 to-blue-800 text-white py-16 sm:py-24">
        ...
        <div className="bg-white p-8 rounded-lg border border-gray-200">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            {['Product Team', 'Engineering', 'Design'].map((role, idx) => (
              <div key={idx}>
                <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-blue-600 rounded-full mx-auto mb-4" />
      ...
      {/* Footer CTA */}
      <div className="bg-linear-to-r from-blue-600 to-blue-800 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
